# Pipeline liuzywen-RGBTCC para Imagens Menores e Poucas Pessoas (Small Images)

Este diretório contém a suíte completa de notebooks interativos dedicados ao estudo de **recortes de pequenas dimensões com baixa densidade de pedestres**, utilizando a arquitetura **liuzywen-RGBTCC**.
